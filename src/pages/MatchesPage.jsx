...
const MatchesPage = () => {
  ...
  const fetchMatches = async () => {
    try {
      const response = await axios.get("http://localhost:30002/back2/api/matches");
  ...
  const fetchTeams = async () => {
    try {
      const response = await axios.get("http://localhost:30002/back2/api/teams");
      const data = response.data;
      const list = Array.isArray(data)
        ? data
  ...
  const createMatch = async () => {
    ...
    try {
      await axios.post("http://localhost:30002/back2/api/matches", {
